...
A small private journal for tracking a child's stomach symptoms, food groups eaten in the last 24 hours, and bowel movements. Built with Next.js for Vercel and Neon Postgres. This is a record to share with a clinician, not a diagnostic tool.
...
4. Sign in, save a symptom check-in, food groups from the last 24 hours, and a bathroom note. Test the daily timeline, delete, and CSV export.
